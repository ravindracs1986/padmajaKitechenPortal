                            ...
                            <aside>
                                <div class="sidebar">
                                    <div class="inner-box">
                                        <h3>Categories</h3>
                                        <ul class="cat-list">
                                            <li><a href="${pageContext.request.contextPath}/breakFast-creeds">BreakFast Creeds <span class="num-posts">(${details.brekFastCount})
										</span></a></li>
                                            <li><a href="${pageContext.request.contextPath}/launch-creeds">Launch Creeds <span class="num-posts">(${details.launchCount})
										</span></a></li>
                                            <li><a href="${pageContext.request.contextPath}/morning-creeds">Morning Creeds<span class="num-posts">(${details.morningCount})
										</span></a></li>
                                            <li><a href="${pageContext.request.contextPath}/evening-creeds">Evening Creeds <span class="num-posts">(${details.eveningCount})
										</span></a></li>
                                            <li><a href="${pageContext.request.contextPath}/dinar-creeds">Dinar Creeds <span class="num-posts">(${details.dinarCount})</span></a></li>
                                             <li><a href="${pageContext.request.contextPath}/sweets-creeds">Sweets Creeds <span class="num-posts">(${details.sweetsCount})</span></a></li>
                                        </ul>
                                    </div>
